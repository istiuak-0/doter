...
<template>
  <div class="inline-flex rounded-lg border border-border bg-card -space-x-px" role="group">
    <button ref="toggleBtn" type="button"
      class="text-body hover:bg-muted hover:text-heading font-medium rounded-l-lg text-sm px-3 py-2 min-h-11 min-w-11 flex items-center justify-center"
      aria-label="Toggle Sidebar" @click="toggleSidebar">
      <Icon icon="lucide:folder-open" class="w-5 h-5" />
    </button>

    <button type="button"
      class="text-body hover:bg-muted hover:text-heading font-medium rounded-r-lg text-sm px-3 py-2 min-h-11 min-w-11 flex items-center justify-center"
      aria-label="Settings">
